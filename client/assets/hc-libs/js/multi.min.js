  ...
  var e = function (e, t, n) {
    ...
    t = function (e, t) {
      ...
      for (var d = null, r = null, l = 0; l < e.options.length; l++) {
        ...
        if (p.tabIndex = 0, p.className = "item delete", p.innerText = c, p.setAttribute("role", "button"), p.setAttribute("data-value", o), p.setAttribute("multi-index", l),  p.setAttribute("onclick", "return confirm('Are you sure?');"),s.disabled && (p.className += " disabled"), s.selected) {
