    ...
    (AnyTime.Converter = function (b) {
      ...
      ;(this.fmt = '%Y-%m-%d %T'),
        ...
        (this.format = function (a) {
          ...
          h == Number.MIN_VALUE &&
            j != Number.MIN_VALUE &&
            b.setTime(b.getTime() + 6e4 * b.getTimezoneOffset() + 6e4 * j)
            ...
            if ('%' != this.fmt.charAt(f)) e += this.fmt.charAt(f)
              ...
              switch (g) {
                ...
                case '@':
                  if (
                    ((d = h != Number.MIN_VALUE ? h : j == Number.MIN_VALUE ? 0 - b.getTimezoneOffset() : j),
                    AnyTime.utcLabel && AnyTime.utcLabel[d])
                  ) {
        ...
        (this.parse = function (a) {
          ;(i = l), (m = -1)
          for (
            var b, h, j, k, o, p = 1, q = new Date(4, 0, 1, 0, 0, 0, 0), r = a.length, s = 0, t = 1, u = l, v = 0;
            c > v;
            v++
          )
            if ('%' == this.fmt.charAt(v)) {
              ...
              switch (w) {
                ...
                case 'C':
                  ...
                  break
                case 'c':
                  r > s + 1 && this.dAt(a, s + 1)
                    ? (q.setMonth((Number(a.substr(s, 2)) - 1) % 12), (s += 2))
                    : (q.setMonth((Number(a.substr(s, 1)) - 1) % 12), s++)
                  break
                case 'D':
                  r > s + 1 && this.dAt(a, s + 1)
                    ? (q.setDate(Number(a.substr(s, 2))), (s += 4))
                    : (q.setDate(Number(a.substr(s, 1))), (s += 3))
                  break
                case 'd':
                ...
                case 'E':
                  if (((k = this.eAbbr[0].length), r >= s + k && a.substr(s, k) == this.eAbbr[0])) (p = -1), (s += k)
                    ...
                    if (!(s + (k = this.eAbbr[1].length) <= r && a.substr(s, k) == this.eAbbr[1]))
                      throw 'unknown era: ' + a.substr(s)
                    s += k
                  }
                  break
                case 'e':
                  r > s + 1 && this.dAt(a, s + 1)
                    ? (q.setDate(Number(a.substr(s, 2))), (s += 2))
                    : (q.setDate(Number(a.substr(s, 1))), s++)
                  break
                case 'f':
                  s += 6
                  break
                ...
                case 'k':
                  r > s + 1 && this.dAt(a, s + 1)
                    ? (q.setHours(Number(a.substr(s, 2))), (s += 2))
                    : (q.setHours(Number(a.substr(s, 1))), s++)
                  break
                case 'l':
                  r > s + 1 && this.dAt(a, s + 1)
                    ? (q.setHours(Number(a.substr(s, 2))), (s += 2))
                ...
                case 'p':
                  12 == q.getHours()
                    ? 'A' == a.charAt(s) && q.setHours(0)
                    : 'P' == a.charAt(s) && q.setHours(q.getHours() + 12),
                    (s += 2)
                  break
                case 'r':
                  q.setHours(Number(a.substr(s, 2))),
                    ...
                    12 == q.getHours()
                      ? 'A' == a.charAt(s + 8) && q.setHours(0)
                      : 'P' == a.charAt(s + 8) && q.setHours(q.getHours() + 12),
                    (s += 10)
                  break
                case 'S':
                case 's':
                ...
                case 'y':
                  ;(b = 2),
                    '-' == a.substr(s, 1) && b++,
                    (o = Number(a.substr(s, b))),
                    (o += 'number' == typeof this.baseYear ? this.baseYear : 70 > o ? 2e3 : 1900),
                    q.setFullYear(o),
                    (s += b)
                  break
                case 'Z':
                ...
                case '#':
                  for (
                    '-' == a.charAt(s++) && (t = -1), u = 0;
                    r > s && String((b = Number(a.charAt(s)))) == a.charAt(s);
                    s++
                  )
                    u = 10 * u + b
                  u *= t
                ...
                case ';':
                  '-' == a.charAt(s++) && (t = -1),
                    (u = Number(a.charAt(s))),
                    ('+' == w || ':' == w || (r > s + 3 && String(Number(a.charAt(s + 3))) !== a.charAt(s + 3))) &&
                      (u = 10 * u + Number(a.charAt(++s))),
                    (u *= 60),
                    (':' == w || ';' == w) && s++,
          ...
          return (
            0 > p && q.setFullYear(0 - q.getFullYear()),
            u != Number.MIN_VALUE && (n ? (i = u) : q.setTime(q.getTime() - 6e4 * u - 6e4 * q.getTimezoneOffset())),
            q
          )
        }),
        ...
        (function (h) {
          ...
          if (
            ...
            for (h.dNames = a.makeArray(b.dayNames), d = 1, f = 1e3, i = 0; 7 > i; i++)
              (k = h.dNames[i].length), k > d && (d = k), f > k && (f = k)
          if (
            (b.eraAbbreviations && (h.eAbbr = a.makeArray(b.eraAbbreviations)),
            b.monthAbbreviations && (h.mAbbr = a.makeArray(b.monthAbbreviations)),
            b.monthNames)
          )
            for (h.mNames = a.makeArray(b.monthNames), e = 1, g = 1e3, i = 0; 12 > i; i++)
              (k = h.mNames[i].length), k > e && (e = k), g > k && (g = k)
          'undefined' != typeof b.utcFormatOffsetImposed && (j = b.utcFormatOffsetImposed),
            'undefined' != typeof b.utcParseOffsetAssumed && (l = b.utcParseOffsetAssumed),
            b.utcParseOffsetCapture && (n = !0)
        })(this)
    }),
    ...
    (AnyTime.picker = function (e, f) {
      ...
      ;(d[e] = {
        ...
        initialize: function (d) {
          if (
            ((g = this),
            (this.id = 'AnyTime--' + d.replace(/[^-_.A-Za-z0-9]/g, '--AnyTime--')),
            (f = jQuery.extend(!0, {}, f || {})),
            (f.utcParseOffsetCapture = !0),
            (this.conv = new AnyTime.Converter(f)),
            f.placement)
          )
          ...
          f.latest && (this.latest = this.makeDate(f.latest)),
            (this.lX = f.labelDismiss || 'X'),
            (this.lY = f.labelYear || 'Year'),
            (this.lO = f.labelTimeZone || 'Time Zone')
          var e,
            h,
            i,
            j = 0,
            k = this.conv.fmt
          this.askEra =
            'undefined' != typeof f.askEra
              ? f.askEra
              : k.indexOf('%B') >= 0 || k.indexOf('%C') >= 0 || k.indexOf('%E') >= 0
          ...
          s &&
            ...
            (this.div = a(
              '<div class="AnyTime-win AnyTime-pkr ui-widget ui-widget-content ui-corner-all" id="' +
                this.id +
                '" aria-live="off"></div>',
            )),
          ...
          if (
            ...
            if (
              ...
              for (
                i = f.labelMonth || 'Month',
                  this.hMo = a('<h6 class="AnyTime-lbl AnyTime-lbl-month">' + i + '</h6>'),
            ...
            if (n) {
              ...
              for (h.append(w), e = 0; 7 > e; e++)
                w.append(
                  '<th class="AnyTime-dow AnyTime-dow' +
                    String(e + 1) +
                    '">' +
                    this.conv.dAbbr[(this.fDOW + e) % 7] +
                    '</th>',
                )
          ...
          if (t) {
            ...
            if (((this.dT = a('<div class="AnyTime-time"></div>')), this.dB.append(this.dT), p)) {
              ;(this.dH = a('<div class="AnyTime-hrs"></div>')),
                this.dT.append(this.dH),
                (i = f.labelHour || 'Hour'),
                this.dH.append(a('<h6 class="AnyTime-lbl AnyTime-lbl-hr">' + i + '</h6>'))
            ...
            if (q) {
              ...
              for (; 12 > e; e++)
                this.btn(z, '&#160;', a.noop, ['min-ten', 'min' + e + '0'], i + ' ' + e + '0').addClass(
              ...
              for (A = a('<ul class="AnyTime-mins-ones"/>'), this.dM.append(A), e = 0; 10 > e; e++)
                this.btn(
                  ...
                  function (b) {
                    ...
                    if (!c.hasClass('AnyTime-out-btn')) {
                      var d = new Date(this.time.getTime())
                      d.setMinutes(10 * Math.floor(this.time.getMinutes() / 10) + Number(c.text())),
                        this.set(d),
                        this.upd(c)
                    }
                  },
              ...
              for (; 12 > e; e++)
                this.btn(A, '&#160;', a.noop, ['min-one', 'min' + e + '0'], i + ' ' + e).addClass(
            ...
            if (r) {
              ...
              for (; 12 > e; e++)
                this.btn(z, '&#160;', a.noop, ['sec-ten', 'sec' + e + '0'], i + ' ' + e + '0').addClass(
              ...
              for (A = a('<ul class="AnyTime-secs-ones"/>'), this.dS.append(A), e = 0; 10 > e; e++)
                this.btn(
                  ...
                  function (b) {
                    ...
                    if (!c.hasClass('AnyTime-out-btn')) {
                      var d = new Date(this.time.getTime())
                      d.setSeconds(10 * Math.floor(this.time.getSeconds() / 10) + Number(c.text())),
                        this.set(d),
                        this.upd(c)
                    }
                  },
              ...
              for (; 12 > e; e++)
                this.btn(A, '&#160;', a.noop, ['sec-one', 'sec' + e + '0'], i + ' ' + e).addClass(
          ...
          f.labelTitle
            ? this.hTitle.append(f.labelTitle)
            : j > 1
            ? this.hTitle.append('Select a ' + (o ? (t ? 'Date and Time' : 'Date') : 'Time'))
            : this.hTitle.append('Select')
          try {
            ;(this.time = this.conv.parse(this.inp.val())),
              (this.offMin = this.conv.getUtcParseOffsetCaptured()),
              (this.offSI = this.conv.getUtcParseOffsetSubIndex()),
              'init' in f && (this.time = this.makeDate(f.init))
          } catch (D) {
            this.time = new Date()
          }
        ...
        askOffset: function (b) {
          if (this.oDiv) this.cloak.show(), this.oDiv.show()
            ...
            this.oDiv.append(c),
              (this.oBody = a('<div class="AnyTime-body AnyTime-body-off-selector"></div>')),
              ...
              for (var i = -720; 840 >= i; i++)
                if (AnyTime.utcLabel[i]) {
                  ...
                  for (
                    ...
                    (this.oConv.setUtcFormatOffsetSubIndex(j),
                    (f = this.btn(e, this.oConv.format(this.time), this.newOPos, ['off-off'], i)),
                    (f[0].AnyTime_offMin = i),
                    (f[0].AnyTime_offSI = j),
                    h);
                    j++
                  );
            ...
            this.oDiv.outerWidth(!0) > this.div.width() &&
              (this.oBody.css('width', '0'),
              this.oBody.css(
                'width',
                String(this.div.width() - (this.oDiv.outerWidth(!0) + this.oBody.outerWidth(!1))) + 'px',
              ))
          }
          ...
          if (this.yDiv) this.cloak.show(), this.yDiv.show()
            ...
            for (
              this.yDiv.append(e),
                ...
                e.append(cont),
                this.y0XXX = this.btn(cont, 0, this.newYPos, ['mil', 'mil0'], this.lY + ' 0000'),
                i = 1;
              10 > i;
              i++
            )
              this.btn(cont, i, this.newYPos, ['mil', 'mil' + i], this.lY + ' ' + i + '000')
            for (cont = a('<ul class="AnyTime-yr-cent" />'), e.append(cont), i = 0; 10 > i; i++)
              this.btn(cont, i, this.newYPos, ['cent', 'cent' + i], this.lY + ' ' + i + '00')
            for (cont = a('<ul class="AnyTime-yr-dec" />'), e.append(cont), i = 0; 10 > i; i++)
              this.btn(cont, i, this.newYPos, ['dec', 'dec' + i], this.lY + ' ' + i + '0')
            for (cont = a('<ul class="AnyTime-yr-yr" />'), e.append(cont), i = 0; 10 > i; i++)
        ...
        inpBlur: function (a) {
          return this.oDiv && this.oDiv.is(':visible')
            ...
            : ((this.lostFocus = !0),
              setTimeout(function () {
                g.lostFocus &&
                  (g.div.find('.AnyTime-focus-btn').removeClass('AnyTime-focus-btn ui-state-focus'),
                  g.pop ? g.dismiss(a) : g.ajax())
              }, 334),
              void 0)
        },
        btn: function (b, c, d, e, f) {
          for (
            var h = 'ul' == b[0].nodeName.toLowerCase() ? 'li' : 'td', i = '<' + h + ' class="AnyTime-btn', j = 0;
            j < e.length;
            j++
          )
            i += ' AnyTime-' + e[j] + '-btn'
        ...
        cleanup: function () {
          this.inp
            ...
            a(window).off('resize', this.hResize),
            this.div.remove()
        },
        dismiss: function () {
          this.ajax(),
            this.yDiv && this.dismissYDiv(),
            this.oDiv && this.dismissODiv(),
            this.div.hide(),
            (this.lostFocus = !0)
        },
        ...
        setFocus: function (a) {
          if (
            ...
            var b = this.oBody.offset().top,
              ...
              d = a.outerHeight(!0)
            b > c - d
              ? this.oBody.scrollTop(c + this.oBody.scrollTop() - (this.oBody.innerHeight() + b) + 2 * d)
              : c + d > b + this.oBody.innerHeight() && this.oBody.scrollTop(c + this.oBody.scrollTop() - (b + d))
          }
        },
        key: function (a) {
          var c,
          ...
          if (((this.denyTab = !0), 16 == f));
          else if (10 == f || 13 == f || 27 == f)
            this.oDiv && this.oDiv.is(':visible')
              ? this.dismissODiv(a)
              : this.yDiv && this.yDiv.is(':visible')
              ? this.dismissYDiv(a)
              : this.pop && this.dismiss(a)
            ...
            if (this.fBtn.hasClass('AnyTime-off-off-btn')) 9 == f && this.dismissODiv(a)
              ...
              ;(d = new Date(this.time.getTime())),
                a.shiftKey
                  ...
                  : ((c = d.getMonth() - 1), d.getDate() > b[c] && d.setDate(b[c]), d.setMonth(c)),
                this.keyDateChange(d)
              ...
              if ((d = this.dM ? this.dM.find('.AnyTime-mins-ones') : this.dH || this.dDoM || this.dMo))
              ...
              if (
                (d = this.dS
                  ? this.dS.find('.AnyTime-secs-ones')
                  : this.dM
                  ? this.dM.find('.AnyTime-mins-ones')
                  : this.dH || this.dDoM || this.dMo)
              )
                d.AnyTime_clickCurrent()
              else if (this.dY) this.yCur.triggerHandler('click')
              else if (9 == f) return (this.denyTab = !1), void 0
            ...
            if (this.fBtn.hasClass('AnyTime-mil-btn'))
              ...
              (d = this.yDiv.find('.AnyTime-era-btn.AnyTime-cur-btn')),
                d.length ? d.triggerHandler('click') : 9 == f && this.dismissYDiv(a)
            ...
            this.fBtn.hasClass('AnyTime-mil-btn') ||
            ...
            this.fBtn.hasClass('AnyTime-era-btn')
              ? ((d = this.yDiv.find('.AnyTime-ce-btn')),
                d.length || (d = this.yDiv.find('.AnyTime-yr9-btn')),
            ...
            this.fBtn.hasClass('AnyTime-dom-btn')
              ? ((d = new Date(this.time.getTime())), d.setDate(d.getDate() - 1), this.keyDateChange(d))
              : this.keyBack()
          else if (38 == f)
            this.fBtn.hasClass('AnyTime-dom-btn')
              ? ((d = new Date(this.time.getTime())), d.setDate(d.getDate() - 7), this.keyDateChange(d))
              : this.keyBack()
          else if (39 == f)
            this.fBtn.hasClass('AnyTime-dom-btn')
              ? ((d = new Date(this.time.getTime())), d.setDate(d.getDate() + 1), this.keyDateChange(d))
        ...
        keyDateChange: function (a) {
          this.fBtn.hasClass('AnyTime-dom-btn') &&
            (this.set(a), this.upd(null), this.setFocus(this.dDoM.find('.AnyTime-cur-btn')))
        },
        makeCloak: function () {
          this.cloak
            ? this.cloak.show()
        ...
        makeDate: function (a) {
          if (
            ('number' == typeof a ? (a = new Date(a)) : 'string' == typeof a && (a = this.conv.parse(a)),
            'getTime' in a)
          )
            return a
        ...
        newHour: function (b) {
          ...
          if (!e.hasClass('AnyTime-out-btn')) {
            if (this.twelveHr) {
              ...
              ;(d = f.indexOf('a')),
                0 > d
                  ? ((d = Number(f.substr(0, f.indexOf('p')))), (c = 12 == d ? 12 : d + 12))
                  : ((d = Number(f.substr(0, d))), (c = 12 == d ? 0 : d))
        ...
        onReady: function () {
          ;(this.lostFocus = !0),
            this.pop ? this.div.parent() != document.body && this.div.appendTo(document.body) : this.upd(null)
        },
        pos: function () {
          if (this.pop) {
            ...
            0 > f && (f = b.top + this.inp.outerHeight(!0)),
              this.div.css({ top: String(f) + 'px', left: String(0 > e ? 0 : e) + 'px' })
          }
          var g = this.div.offset()
          if (this.oDiv && this.oDiv.is(':visible')) {
            var h = this.oLab.offset()
            'absolute' == this.div.css('position') &&
              ((h.top -= g.top), (h.left = h.left - g.left), (g = { top: 0, left: 0 }))
            ...
            ;(h.top += this.oLab.outerHeight(!0)),
              h.top + k > g.top + l && (h.top = h.top - k),
              h.top < g.top && (h.top = g.top),
              this.oDiv.css({ top: h.top + 'px', left: h.left + 'px' })
          } else if (this.yDiv && this.yDiv.is(':visible')) {
            var m = this.yLab.offset()
            'absolute' == this.div.css('position') &&
              ((m.top -= g.top), (m.left = m.left - g.left), (g = { top: 0, left: 0 })),
        ...
        set: function (a) {
          var b = a.getTime()
          this.time =
            this.earliest && b < this.earliest.getTime()
              ? new Date(this.earliest.getTime())
              : this.latest && b > this.latest.getTime()
              ? new Date(this.latest.getTime())
              : a
        },
        ...
        upd: function (b) {
          ...
          ;(h = this.time.getMonth()),
            a('#' + this.id + ' .AnyTime-mon-btn').each(function () {
              c.setMonth(i),
                ...
                d.setMonth(i + 1),
                d.setDate(0),
                a(this).AnyTime_current(i == h, (!g.earliest || d.getTime() >= e) && (!g.latest || c.getTime() <= f)),
                i++
            }),
            c.setFullYear(this.time.getFullYear()),
            d.setFullYear(this.time.getFullYear()),
                  ...
                  if (n - g.fDOW < 7) {
                    ...
                    ;(0 == m && l > n) || c.getMonth() != j
                      ? (b.html('&#160;'),
                        ...
                        m
                          ? (1 == c.getDate() && 0 != n
                              ? b.addClass('AnyTime-dom-btn-empty-after-filled')
                              : b.removeClass('AnyTime-dom-btn-empty-after-filled'),
                            c.getDate() <= 7
                              ? b.addClass('AnyTime-dom-btn-empty-below-filled')
                              : b.removeClass('AnyTime-dom-btn-empty-below-filled'),
                            c.setDate(c.getDate() + 1),
                            d.setDate(d.getDate() + 1))
                          : (b.addClass('AnyTime-dom-btn-empty-above-filled'),
                            n == l - 1
                              ? b.addClass('AnyTime-dom-btn-empty-before-filled')
                              : b.removeClass('AnyTime-dom-btn-empty-before-filled')),
          ...
          a('#' + this.id + ' .AnyTime-hr-btn').each(function () {
            ...
            o
              ? (b = Number(h))
              : ((b = Number(h.substring(0, h.length - 2))),
                'a' == h.charAt(h.length - 2) ? 12 == b && (b = 0) : 12 > b && (b += 12)),
              c.setHours(b),
              d.setHours(b),
          ...
          if (
            (a('#' + this.id + ' .AnyTime-min-ten-btn:not(.AnyTime-min-ten-btn-empty)').each(function () {
              a(this).AnyTime_current(
                this.innerHTML == r,
                (!g.earliest || d.getTime() >= e) && (!g.latest || c.getTime() <= f),
              ),
                c.getMinutes() < 50 && (c.setMinutes(c.getMinutes() + 10), d.setMinutes(d.getMinutes() + 10))
            }),
            ...
            a('#' + this.id + ' .AnyTime-sec-ten-btn:not(.AnyTime-sec-ten-btn-empty)').each(function () {
              a(this).AnyTime_current(
                ...
                c.getSeconds() < 50 && (c.setSeconds(c.getSeconds() + 10), d.setSeconds(d.getSeconds() + 10))
            }),
        ...
        updODiv: function (b) {
          ...
          this.oDiv.find('.AnyTime-off-off-btn').each(function () {
            this.AnyTime_offMin == g.offMin
              ? this.AnyTime_offSI == g.offSI
                ? a(this).AnyTime_current((c = !0), !0)
                : (a(this).AnyTime_current(!1, !0), null == d && (d = a(this)))
              : a(this).AnyTime_current(!1, !0)
          }),
        ...
        updYDiv: function (b) {
          ...
          ;(c = 0),
            this.yDiv.find('.AnyTime-mil-btn').each(function () {
              ;(d =
                (!g.earliest || e * (c + (0 > e ? 0 : 999)) >= h) && (!g.latest || i >= e * (c + (e > 0 ? 0 : 999)))),
                a(this).AnyTime_current(this.innerHTML == f.substring(0, 1), d),
                (c += 1e3)
            }),
            (c = 1e3 * Math.floor(f / 1e3)),
            this.yDiv.find('.AnyTime-cent-btn').each(function () {
              ;(d = (!g.earliest || e * (c + (0 > e ? 0 : 99)) >= h) && (!g.latest || i >= e * (c + (e > 0 ? 0 : 99)))),
                a(this).AnyTime_current(this.innerHTML == f.substring(1, 2), d),
                (c += 100)
            }),
            (c = 100 * Math.floor(f / 100)),
            this.yDiv.find('.AnyTime-dec-btn').each(function () {
              ;(d = (!g.earliest || e * (c + (0 > e ? 0 : 9)) >= h) && (!g.latest || i >= e * (c + (e > 0 ? 0 : 9)))),
                a(this).AnyTime_current(this.innerHTML == f.substring(2, 3), d),
                (c += 10)
            }),
            (c = 10 * Math.floor(f / 10)),
            this.yDiv.find('.AnyTime-yr-btn').each(function () {
              ;(d = (!g.earliest || e * c >= h) && (!g.latest || i >= e * c)),
                a(this).AnyTime_current(this.innerHTML == f.substring(3), d),
                (c += 1)
            }),
