...
!(function (a) {
  ...
  function b(f, g, i, m) {
    function n() {
      return b._.node(
        'div',
        b._.node('div', b._.node('div', b._.node('div', B.component.nodes(w.open), y.box), y.wrap), y.frame),
        y.holder,
        'tabindex="-1"',
      )
    }
    ...
    function u(a) {
      ...
      return 27 == b
        ...
        : void (
            ...
            (a.preventDefault(), a.stopPropagation(), c ? B.clear().close() : B.open())
          )
    }
    if (!f) return b
    var v = !1,
                ...
                j
                  ...
                  .on('keydown.' + w.id, function (c) {
                    ...
                    27 == d
                      ? B.close(!0)
                      : f != B.$holder[0] || (!e && 13 != d)
                      ? a.contains(B.$root[0], f) && 13 == d && (c.preventDefault(), f.click())
                      : (c.preventDefault(),
                        e
                          ? b._.trigger(B.component.key.go, B, [b._.trigger(e)])
                          : B.$root.find('.' + y.highlighted).hasClass(y.disabled) ||
                            (B.set('select', B.component.item.highlight), x.closeOnSelect && B.close(!0)))
                  })),
              B.trigger('open'))
        },
        close: function (a) {
  ...
  function c(a) {
    var b,
      c = 'position'
    return (
      a.currentStyle ? (b = a.currentStyle[c]) : window.getComputedStyle && (b = getComputedStyle(a)[c]), 'fixed' == b
    )
  }
  function d() {
...
!(function (a) {
  'function' == typeof define && define.amd
    ? define(['picker', 'jquery'], a)
    : 'object' == typeof exports
    ? (module.exports = a(require('picker.html'), require('jquery')))
    : a(Picker, jQuery)
})(function (a, b) {
  function c(a, b) {
    var c = this,
      ...
      return (
        'flip' == c
          ...
          : c.map(function (a) {
              ...
              c ||
                ((f.isInteger(a) || f.isDate(a) || b.isArray(a) || (b.isPlainObject(a) && a.from && a.to)) && e.push(a))
            }),
        e
      )
    }),
              ...
              for (i = 0; g > i; i += 1) {
                ...
                if (d.isDateOverlap(h, a)) {
                  b.isPlainObject(a)
                    ...
                    : f.isDate(a) && (c = [a.getFullYear(), a.getMonth(), a.getDate(), 'inverted'])
                  break
                }
              }
              if (c)
        ...
        p = function (a) {
          return f.node(
            ...
            'data-nav=' +
              (a || -1) +
              ' ' +
              f.ariaAttr({ role: 'button', controls: b.$node[0].id + '_table' }) +
              ' title="' +
                  ...
                  item: function (a) {
                    return [
                      ...
                      'value=' +
                        a +
                        (k.month == a ? ' selected' : '') +
                        ((k.year == m.year && a < m.month) || (k.year == n.year && a > n.month) ? ' disabled' : ''),
                    ]
                  },
                }),
                c.klass.selectMonth,
        ...
        f.node(
          ...
          f.node(
            ...
            f.node(
              ...
              c.clear,
              c.klass.buttonClear,
              'type=button data-clear=1' + (a ? '' : ' disabled') + ' ' + f.ariaAttr({ controls: b.$node[0].id }),
            ) +
            f.node(
              'button',
              c.close,
              c.klass.buttonClose,
              'type=button data-close=true ' + (a ? '' : ' disabled') + ' ' + f.ariaAttr({ controls: b.$node[0].id }),
            ),
          c.klass.footer,
        )
      )
