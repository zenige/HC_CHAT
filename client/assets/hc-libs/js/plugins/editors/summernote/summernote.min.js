...
!(function (t, e) {
  ...
  var e = (function () {
    ...
    h = o('<div class="dropdown-menu" role="list">', function (e, o) {
      var n = t.isArray(o.items)
        ? o.items
            ...
            .join('')
        : o.items
      e.html(n).attr({ 'aria-label': o.title })
    }),
    p = o(
    ...
    y = {
      ...
      createLayout: function (t, e) {
        var o = (
          e.airMode
            ? y.airEditor([y.editingArea([y.airEditable()])])
            : y.editor([
                y.toolbar(),
                y.editingArea([y.codable(), y.editable()]),
                y.statusbar(),
              ])
        ).render()
        return (
  ...
  if (P) {
    ...
    L && (A = parseFloat(L[1])),
      (L = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(R)) &&
        (A = parseFloat(L[1]))
  }
  var H = /Edge\/\d+/.test(R),
    D = !!window.CodeMirror
  if (!D && E)
    if ('function' == typeof __webpack_require__)
      ...
      else void 0 !== require.specified && (D = require.specified('codemirror'))
  var F =
    ...
    return n.length
      ? 1 === n.length
        ...
        : n.reduce(function (t, n) {
            return (
              t === e.node && (t = wt(e, o)),
              wt({ node: n, offset: t ? vt(t) : it(n) }, o)
            )
          })
      : null
  }
  ...
  var Et = {
    ...
    At = {
      isEdit: function (t) {
        return N.contains(
          [Et.BACKSPACE, Et.TAB, Et.ENTER, Et.SPACE, Et.DELETE],
          t
        )
      },
      isMove: function (t) {
  ...
  function Pt(t) {
    var e = function (t, o) {
        ...
        if (Nt.isText(t)) {
          ...
          ;(n = s || t.parentNode),
            (o += N.sum(N.tail(r), Nt.nodeLength)),
            (i = !s)
        } else {
      ...
      return (
        ...
        (e.prototype.nodes = function (t, e) {
          ...
          return (
            Nt.walkPoint(
              ...
              function (e) {
                var i
                Nt.isEditable(e.node) ||
                  (n
                    ? (Nt.isLeftEdgePoint(e) && a.push(e.node),
                      Nt.isRightEdgePoint(e) &&
                        N.contains(a, e.node) &&
                        (i = e.node))
                    : (i = o ? Nt.ancestor(e.node, t) : e.node),
                  i && t(i) && s.push(i))
              },
              !0
            ),
        ...
        (e.prototype.deleteContents = function () {
          ...
          return (
            t.each(n, function (t, e) {
              var o = e.parentNode
              i.node !== o && 1 === Nt.nodeLength(o) && r.push(o),
                Nt.remove(e, !1)
            }),
        ...
        (e.prototype.wrapBodyInlineWithPara = function () {
          ...
          if (Nt.isInline(o.sc)) {
            ...
            ;(t = N.last(n)),
              Nt.isInline(t) || (t = n[n.length - 2] || o.sc.childNodes[o.so])
          } else t = o.sc.childNodes[o.so > 0 ? o.so - 1 : 0]
          var i = Nt.listPrev(t, Nt.isParaInline).reverse()
          if (
            (i = i.concat(Nt.listNext(t.nextSibling, Nt.isParaInline))).length
          ) {
        ...
        (e.prototype.getWordRange = function (t) {
          ...
          return (
            t &&
              (o = Nt.nextPointUntil(o, function (t) {
                return !Nt.isCharPoint(t)
              })),
      ...
      create: function (t, e, o, n) {
        ...
        return i || 1 !== arguments.length
          ...
          : (i = this.createFromNode(arguments[0])).collapse(
              Nt.emptyPara === arguments[0].innerHTML
            )
      },
      ...
      return (
        ...
        (t.prototype.applySnapshot = function (t) {
          null !== t.contents && this.$editable.html(t.contents),
            null !== t.bookmark &&
              Ht.createFromBookmark(this.editable, t.bookmark).select()
        }),
    ...
    Ft = (function () {
      ...
      return (
        ...
        (e.prototype.current = function (e) {
          ...
          return (
            (n.anchor = e.isOnAnchor() && Nt.ancestor(e.sc, Nt.isAnchor)),
            (n.ancestors = Nt.listAncestor(e.sc, Nt.isEditable)),
            (n.range = e),
            n
          )
        }),
              ...
              var r = N.head(i),
                ...
                l =
                  a.childNodes.length > 1
                    ? Nt.splitTree(
                        a,
                        { node: s.parentNode, offset: Nt.position(s) + 1 },
                        { isSkipPaddingBlankHTML: !0 }
                      )
                    : null,
                c = Nt.splitTree(
                  a,
                  { node: r.parentNode, offset: Nt.position(r) },
                  { isSkipPaddingBlankHTML: !0 }
                )
              ;(i = o
                ? Nt.listDescendant(c, Nt.isLi)
                : N.from(c.childNodes).filter(Nt.isLi)),
                (!o && Nt.isList(a.parentNode)) ||
                  (i = i.map(function (t) {
      ...
      return (
        (e.prototype.insertTab = function (t, e) {
          ...
          ;(t = t.deleteContents()).insertNode(o, !0),
            (t = Ht.create(o, e)).select()
        }),
        (e.prototype.insertParagraph = function (e) {
          var o = Ht.create(e)
          o = (o = o.deleteContents()).wrapBodyInlineWithPara()
          var n,
            i = Nt.ancestor(o.sc, Nt.isPara)
          if (i) {
            if (Nt.isEmpty(i) && Nt.isLi(i))
              return void this.bullet.toggleList(i.parentNode.nodeName)
            if (Nt.isEmpty(i) && Nt.isPara(i) && Nt.isBlockquote(i.parentNode))
              Nt.insertAfter(i, i.parentNode), (n = i)
            else {
              n = Nt.splitTree(i, o.getStartPoint())
              var r = Nt.listDescendant(i, Nt.isEmptyAnchor)
              ;(r = r.concat(Nt.listDescendant(n, Nt.isEmptyAnchor))),
                t.each(r, function (t, e) {
                  Nt.remove(e)
                }),
                (Nt.isHeading(n) || Nt.isPre(n) || Nt.isCustomStyleTag(n)) &&
                  Nt.isEmpty(n) &&
                  (n = Nt.replace(n, 'p'))
            }
          } else {
      ...
      ;(this.getActionList = function () {
        for (
          var t,
            n,
            a,
            l = e === Mt.where.Row ? i.rowPos : -1,
            c = e === Mt.where.Column ? i.colPos : -1,
            d = 0,
            p = !0;
          p;
          ...
          s.push(
            ...
            (a = m),
            {
              baseCell: v.baseCell,
              action: t,
              virtualTable: { rowIndex: n, cellIndex: a },
            })
          ),
            d++
        }
        ...
        (e.prototype.addCol = function (e, o) {
          ...
          for (
            ...
            switch (a.action) {
              case Mt.resultAction.AddCell:
                'right' === o
                  ? t(a.baseCell).after('<td' + l + '>' + Nt.blank + '</td>')
                  : t(a.baseCell).before('<td' + l + '>' + Nt.blank + '</td>')
                break
              case Mt.resultAction.SumSpanCount:
                if ('right' === o) {
    ...
    jt = (function () {
      function e(e) {
        ...
        ;(this.context = e),
          ...
          (this.typing = new zt()),
          (this.bullet = new Bt()),
          (this.history = new Dt(this.$editable)),
        ...
        ;(this.insertParagraph = this.wrapCommand(function () {
          ...
          (this.insertNode = this.wrapCommand(function (e) {
            o.isLimited(t(e).text().length) ||
              (o.createRange().insertNode(e),
              Ht.createFromNodeAfter(e).select())
          })),
      ...
      return (
        ...
        (e.prototype.handleKeyMap = function (t) {
          ...
          i
            ...
            : At.isEdit(t.keyCode) && this.afterCommand()
        }),
          ...
          return (
            ...
            (void 0 === e ||
              !(
                ...
                e.ctrlKey ||
                e.metaKey ||
                N.contains([At.code.BACKSPACE, At.code.DELETE], e.keyCode)
              )) &&
          ...
          t
            ...
            .then(function (t) {
              i.beforeCommand(),
                ...
                t.show(),
                Ht.create(i.editable).insertNode(t[0]),
                Ht.createFromNodeAfter(t[0]).select(),
                i.afterCommand()
            })
            .fail(function (t) {
        ...
        (e.prototype.getSelectedText = function () {
          ...
          return (
            t.isOnAnchor() &&
              (t = Ht.createFromNode(Nt.ancestor(t.sc, Nt.isAnchor))),
            t.toString()
          )
        }),
        ...
        (e.prototype.fontStyling = function (e, o) {
          ...
          if (n) {
            ...
            if ((t(i).css(e, o), n.isCollapsed())) {
              ...
              r &&
                !Nt.nodeLength(r) &&
                ((r.innerHTML = Nt.ZERO_WIDTH_NBSP_CHAR),
                Ht.createFromNodeAfter(r.firstChild).select(),
      ...
      return (
        ...
        (t.prototype.pasteByEvent = function (t) {
          ...
          if (e && e.items && e.items.length) {
            ...
            'file' === o.kind &&
              -1 !== o.type.indexOf('image/index.html') &&
    ...
    Yt = (function () {
      ...
      return (
        ...
        (e.prototype.handleKeyup = function (t) {
          N.contains([At.code.ENTER, At.code.SPACE], t.keyCode) &&
            this.replace()
        }),
        e
      )
    ...
    Xt = (function () {
      ...
      return (
          ...
          return this.options.shortcuts && e
            ? (z.isMac && (e = e.replace('CMD', '⌘').replace('SHIFT', '⇧')),
              ' (' +
                (e = e
                  .replace('BACKSLASH', '\\')
                  .replace('SLASH', 'http://demo.interface.club/')
                  .replace('LEFTBRACKET', '[')
        ...
        (e.prototype.addToolbarButtons = function () {
          ...
          this.context.memo('button.justifyLeft', C.invoke(s, 'render')),
            this.context.memo('button.justifyCenter', C.invoke(a, 'render')),
            this.context.memo('button.justifyRight', C.invoke(l, 'render')),
            this.context.memo('button.justifyFull', C.invoke(c, 'render')),
            this.context.memo('button.outdent', C.invoke(d, 'render')),
            this.context.memo('button.indent', C.invoke(u, 'render')),
            ...
            .Deferred(function (t) {
              ...
              o.ui.onDialogShown(o.$dialog, function () {
                ...
                i
                  ...
                  .val(e.url),
                  z.isSupportTouch || i.trigger('focus'),
            ...
            e.ui.onDialogShown(e.$dialog, function () {
              e.context.triggerEvent('dialog.shown'),
                ...
                n
                  ...
                  .val(''),
                z.isSupportTouch || n.trigger('focus'),
                e.bindEnterKey(n, i)
            }),
    ...
    ce = (function () {
      ...
      return (
        ...
        (e.prototype.replace = function () {
          ...
          if (t.length) {
            ...
            this.lastWordRange.insertNode(e),
              Ht.createFromNode(e).collapse().select(),
              (this.lastWordRange = null),
              this.hide(),
              this.context.triggerEvent(
                'change',
        ...
        (e.prototype.handleKeydown = function (t) {
          this.$popover.is(':visible') &&
            (t.keyCode === At.code.ENTER
              ...
              : t.keyCode === At.code.UP
              ? (t.preventDefault(), this.moveUp())
              : t.keyCode === At.code.DOWN &&
        ...
        (e.prototype.handleKeyup = function (t) {
          var e = this
          if (
            !N.contains([At.code.ENTER, At.code.UP, At.code.DOWN], t.keyCode)
          ) {
